module Blocipedia
  ...
  class PaypalPayment
    ...
    #         blocipedia upgrade. It returns true if the payment was created
    #         successfully or false otherwise. It also sets the return and
    #         cancel urls in the payment_urls hash. @return_url and @cancel_url
    #         must be set
    #
    # Examples
    #
    ...
    def create_default_upgrade_payment
      @payment = Payment.new(
        ...
        # Urls to redirect the user to after they aprove
        # or cancel the order
        redirect_urls: {
    ...
    # Public: Sets the approval url obtained from the payment object. This URL
    #         is used to rediect the user to paypal to approval the payment
    #
    # Returns The full URL to rediect the user too as a string
    def set_approval_url
      @payment_urls[:approval_url] = @payment.links
                                     .find { |v| v.method == 'REDIRECT' }.href
    end
  end
end
